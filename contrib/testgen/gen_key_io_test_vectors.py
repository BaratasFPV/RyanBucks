...
bech32_templates = [
  ...
  ('rxb',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('rxb',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('rxb',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('trxb',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('trxb',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('trxb',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rrxb',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rrxb',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rrxb', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('trxb',  17, 32, False, False, False),
  ('rrxb',  3,  1, False, False, False),
  ('rxb',   15, 41, False, False, False),
  ('trxb',  0, 16, False, False, False),
  ('rrxb',  0, 32, True,  False, False),
  ('rxb',   0, 16, True,  False, False),
  ('trxb',  0, 32, False, True,  False),
  ('rrxb',  0, 20, False, False, True)
]
