# Support for Output Descriptors in Ryanbucks Core

Since Ryanbucks Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `rxb1...` for mainnet or `trxb1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Ryanbucks's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ryanbucks Core wallets, a convenience function `combo` is
