Ryanbucks Core version *0.15.1* is now available from:

  <https://download.ryanbucks.org/ryanbucks-0.15.1/>
...
A number of changes to the way Ryanbucks Core deals with peer connections and invalid blocks
