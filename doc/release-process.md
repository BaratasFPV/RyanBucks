...
* Update manpages, see [gen-manpages.sh](https://github.com/ryanbucks-project/ryanbucks/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/ryanbucks-project/ryanbucks-detached-sigs.git
...
- Detached signatures will then be committed to the [ryanbucks-detached-sigs](https://github.com/ryanbucks-project/ryanbucks-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the ryanbucks.org server, nor put them in the torrent*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/ryanbucks-project/ryanbucks/releases/new) with a link to the archived release notes.
