...
const QString BITCOIN_IPC_PREFIX("ryanbucks:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ryanbucks-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ryanbucks-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ryanbucks-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start ryanbucks: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("ryanbucks://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'ryanbucks://' is not a valid URI. Use 'ryanbucks:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Ryanbucks address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
