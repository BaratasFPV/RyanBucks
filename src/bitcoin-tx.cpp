...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ryanbucks-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ryanbucks-tx [options] <hex-tx> [commands]  Update hex-encoded ryanbucks transaction\n" +
            "or:     ryanbucks-tx [options] -create [commands]   Create hex-encoded ryanbucks transaction\n" +
            "\n";
