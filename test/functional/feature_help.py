...
"""Verify that starting ryanbucks with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ryanbucks with -h for help text")
        ...
        self.log.info("Start ryanbucks with -version for version information")
        ...
        self.log.info("Start ryanbucksd with -fakearg to make sure it does not start")
